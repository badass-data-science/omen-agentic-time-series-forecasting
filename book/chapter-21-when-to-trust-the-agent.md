...
- **`residuals_look_like_white_noise`** (Ljung-Box, Chapters 9 and 10): a fixed statistical test with a fixed critical value, not a judgment call about whether a residual plot "looks fine."
